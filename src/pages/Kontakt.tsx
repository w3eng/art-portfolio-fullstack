...
export const Kontakt = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const response = await fetch("https://art-portfolio-fullstack.onrender.com/api/contact", {
      method: "POST",
  ...
  return (
    ...
    >
      ...
      <h2>
      <p className=" text-2xl md:text-3xl font-bold mb-12 text-center">Tel: 123-456-789</p><br/>
      <p className=" text-2xl md:text-3xl font-bold mb-12 text-center">Email.: test@test.pl</p><br/>
      </h2>
      {/* FORMULARZ */}
